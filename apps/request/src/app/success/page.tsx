    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4">
      ...
      >
        <motion.div
          ...
          className="w-20 h-20 mx-auto rounded-full bg-gradient-to-br from-emerald-500 to-teal-500 flex items-center justify-center mb-8 shadow-lg shadow-emerald-500/30"
        >
        ...
        <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link
            href={MAIN_URL}
            className="inline-flex items-center px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium hover:opacity-90 transition-opacity"
          >
            <Home className="w-4 h-4 mr-2" /> Back to Work4You
          </Link>
          <Link
            href={MAIN_URL + "/dashboard"}
            className="inline-flex items-center px-6 py-3 rounded-xl border border-border font-medium hover:bg-muted transition-colors"
          >
